class Parser {
   ...
   ************************************************/
    ...
    boolean isEnd(){return is(TokenTypes.EOF,TokenTypes.LITERAL_ENDIF) || is(TokenTypes.LITERAL_NEXT,TokenTypes.LITERAL_LOOP);}
