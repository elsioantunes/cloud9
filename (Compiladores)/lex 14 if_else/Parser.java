...
class Parser {
   ...
   ************************************************/
    ...
    boolean isEnd(){return is(TokenTypes.EOF,TokenTypes.LITERAL_ENDIF) || is(TokenTypes.LITERAL_ELSE,TokenTypes.LITERAL_LOOP);}
   ...
   ************************************************/
    void noExpected(){
        if(is(TokenTypes.TOKEN_INVALIDO)) {ignore("token inválido");}
            ...
            nextToken(); 
            erros.put(new Erro(666,1,"sei lá o que pode ser",LIN,COL));
            //erro("sei lá o que pode ser em " + LIN +", " + COL);
        }
    }
    void ignore(String str){
        erros.put(new Erro(10,0,"não esperava "+str+" neste momento",LIN,COL));
   ...
   ************************************************/
    ...
    void match(TokenTypes code){
        ...
        else erros.put(new Erro(80,1," esperava "+code+" mas veio "+CODE,LIN,COL));//erro (" esperava "+code+" mas veio "+CODE);
    }
