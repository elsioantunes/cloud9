...
enum TokenTypes{
	...
	LITERAL_DOUBLE, LITERAL_INT, LITERAL_STRING, LITERAL_BOOL,
	LITERAL_PRINT, LITERAL_INPUT, LITERAL_SELECT,
	LITERAL_IF, LITERAL_THEN, LITERAL_ELSE, LITERAL_ENDIF, LITERAL_LOOP,
