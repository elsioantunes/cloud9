import java.util.ArrayList;
    class Comando{
        ...
        String toJava(int s){ return toJava(s,null);}
        String toJava(int s, java.util.ArrayList<Erro> erros){
            String str1 = "";
            ...
            if(erros!=null)
                if(erros.size()>0) // Só tem Warnings
                {
                    for(Erro e:erros)
                    {
                        str1+=e.show();
   ...
   ***********************************************/
    ...
    class Erro extends Comando{
        ...
        boolean hasErrors(ArrayList<Erro> erros)
        {
            for(Erro e:erros)
            {
        ...
        String show(){
            String str1="";
            if(tipo==0)
                str1+="System.out.println(\"#WARNING ["+lin+","+col+"] "+str+"\");";
            if(tipo==1)
                str1+="System.out.println(\"#ERROR "+code+"["+lin+","+col+"] "+str+"\");";
            return str1;
        }
    }