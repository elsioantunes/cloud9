...
class MeuLek extends Scanner{
    ...
    public boolean getToken(){
        ...
        else if( c == '&' ) match( TokenTypes.BIT_AND,  '&', TokenTypes.REL_AND); 
        else if( c == '|' ) match( TokenTypes.BIT_OR,   '|', TokenTypes.REL_OR);
        ...
        // do que foi capturado
            ...
            if(c == '"') 
                ...
                Parser.addErros(402,1,"String sem fim",token.lin,token.col);
            ...
            if(c >= ' ' && c<= '~' && c != '\\'){ // caracteres visíveis
                ...
                if( c == '\'' ) 
                    ...
                    if(c == '\'') 
                        ...
                        Parser.addErros(401,1,"Char/String malformada e sem fim",token.lin,token.col);
                ...
                while(estado!=666){
                    switch(estado){
                        case 0: 
                            ...
                            if( c == '*' ) estado = 1;
                            if( c == '\uffff' ) 
                                Parser.addErros(400,1,"Comment sem fim",token.lin,token.col);
...
class Scanner {    
    ...
    // registra o codigo em caso  de literal string
    public void rCode(TokenTypes code){token.code = code;}
