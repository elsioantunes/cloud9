...
class MeuLek extends Scanner {
    ...
    public boolean getToken(){
        ...
        else if(c==',') match( DELIMIT_COMMA); // Tokens de 1 char
        ...
        // do que foi capturado
            ...
            if(c == '"') 
                ...
                debug("Fodeu: String sem fim", 666);
        }
                ...
                while(estado!=666){
                    switch(estado){
                        case 0: 
                            ...
                            if(c=='*') estado = 1;
                            if(c=='\uffff') 
                                debug("Fodeu: Comment sem fim", 666);
                            break;
                        case 1: 
                            estado = 0;
                            if(c=='/') estado = 666;
...
class Scanner{
    public final int TOKEN_INVALIDO = 0, 
        ...
        T_CHAR = 35, T_STRING = 36, EOF = 37, LITERAL_PRINT = 38, LITERAL_STRING = 39, 
        LITERAL_INT = 40, LITERAL_FLOAT = 41, LITERAL_READ = 42;
    ...
    public final String[] nomes = { 
        ...
        "T_CHAR", "T_STRING", "EOF", "PRINT", "STRING",
        "INT", "FLOAT", "READ",
    };
    ...
    // Captura um novo char do arquivo 
    // e registra em c para processamento
    public void getChar(){
        arquivo.getChar();
        c = arquivo.c;
    }
    
    // consome o char (avança cursor), monta a string e anota o tipo
    // dados que podem mudar até o fim do token
