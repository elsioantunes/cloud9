...
class Parser {               // essencial
    public java.util.HashMap <String, Var> mv;
    ...
    Parser(String arq){
        mv = new java.util.HashMap <String, Var>();
        ml = new MeuLek(arq);
        pog1 = false;
        nextToken();
    }
   ...
   ************************************************/
   ...
   void SETVAR(int tipo, String nome){
       Var v = new Var(tipo);
       mv.put(nome, v);
   }
   
   void SETVAR(String nome, String dado){
       Var v = mv.get(nome);
       v.str = dado;
       v.inic = true;
       mv.put(nome, v);
   ...
   Var GETVAR(String nome){
       if(!mv.containsKey(nome)) erro("A variável "+nome+" não ecziste!");
       Var v = mv.get(nome);
       return v;
   }
   ...
   ************************************************/
    ...
    boolean isEOF(){return is(TokenTypes.EOF);}
    ...
    void matchOpRel(){confirm(TokenTypes.REL_AND, TokenTypes.REL_OR);}
