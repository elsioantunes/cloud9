 class MeuParsa extends Parser{
    ...
    MeuParsa(String arq){
        ...
        if(isEnd()){
            ...
            System.out.println("/*");
                console("Acho que ficou bom o resultado com sucesso.\n\n");
                prog.run(0);
                console("fechou?*/");
    ...
    */
    ...
    void Corpo(){
        while(true){
            ...
            else if(ifMatchWhileCMD()) WhileCMD(0);
            else if(ifMatchUntilCMD()) WhileCMD(1);
            //else if(ifMatchSelCaseCMD()) SelectCaseCMD();
